...
Pour ajouter les textes, on utilise la fonction text de R, ici on utilise les mêmes coordonnées pour la longitude et lattitude car on souhaite que le texte soit au dessus du point créé, "cex" c'est un facteur entre 0 et 1 de la taille finale des caractères, pos c'est ce qui nous permet de décaler le texte au desssus.
